...
export const useGetStaticCurrency = () => {
  ...
  const getUSD = () => axios.get(baseURL, { params: { from: 'USD', to: 'UAH', amount: '1' }, headers: { 'X-RapidAPI-Key': KEY, 'X-RapidAPI-Host': HOST,'Permissions-Policy': 'geolocation=()' } });
  const getEUR = () => axios.get(baseURL, { params: { from: 'EUR', to: 'UAH', amount: '1' }, headers: { 'X-RapidAPI-Key': KEY, 'X-RapidAPI-Host': HOST,'Permissions-Policy': 'geolocation=()' } });
